...
export async function getUserStats(username: string) {
  return apiRequest<UserStats>(`/users/${encodeURIComponent(username)}/stats`);
}

export async function getRatingHistory(username: string) {
  return apiRequest<RatingPoint[]>(
